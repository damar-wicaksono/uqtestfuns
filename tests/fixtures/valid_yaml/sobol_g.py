...
def get_params_saltelli_1995_1(input_dimension: int) -> np.ndarray:
...
def get_params_saltelli_1995_2(input_dimension: int) -> np.ndarray:
...
def get_params_saltelli_1995_3(input_dimension: int) -> np.ndarray:
