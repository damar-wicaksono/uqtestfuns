...
# Long narrow-hill Surface Function from McLain (1974)
...
The McLain S4 function is a two-dimensional function introduced
in {cite}`McLain1974` in the context of drawing contours from scattered data.
The resulting surface models a long narrow hill
running diagonally across the domain.
...
The hill runs diagonally from $(0.0, 10.0)$ to $(10.0, 0.0)$,
with a maximum height of $1.0$ at $(5.5, 5.5)$.
