...
# Gaussian Function from Genz (1984)
...
The Genz Gaussian function (or `GenzGaussian` for short)
is an $M$-dimensional scalar-valued function featuring
a multidimensional bell-shaped peak at the center of the input domain.
...
The Genz Gaussian function is defined as:
...
The shape parameters control the width of the Gaussian peak;
larger values produce a narrower peak and make integration more challenging.
