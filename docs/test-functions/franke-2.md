...
The (2nd) Franke function (`Franke2` for short) is a two-dimensional
scalar-valued function introduced in {cite}`Franke1979` for scattered
data interpolation. It is a modified form of the
{ref}`McLain S5 function <test-functions:mclain-s5>` {cite}`McLain1974`.
...
```{note}
The (2nd) Franke function is a modified form
of the {ref}`McLain S5 function <test-functions:mclain-s5>` {cite}`McLain1974`.
