...
# Gentle-hill Surface Function from McLain (1974)
...
The McLain S3 function is a two-dimensional function introduced
in {cite}`McLain1974` in the context of drawing contours from scattered data.
The resulting surface models a gentle hill rising from a plain.
...
The location of the peak is at $(5.0, 5.0)$ with a maximum height of $1.0$,
with a gentler decay than {ref}`S2 <test-functions:mclain-s2>`.
