...
def mclain_s1(xx: np.ndarray) -> np.ndarray:
...
def mclain_s2(xx: np.ndarray) -> np.ndarray:
...
def mclain_s3(xx: np.ndarray) -> np.ndarray:
...
def mclain_s4(xx: np.ndarray) -> np.ndarray:
...
def mclain_s5(xx: np.ndarray) -> np.ndarray:
